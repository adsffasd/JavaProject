  ...
  <div class="row justify-content-center">
    <div class="col-md-6">
      <div class="card shadow-sm">
        <div class="card-body">
          <h2 class="card-title text-center mb-4">Sửa thông tin dịch vụ</h2>
          <form action="${pageContext.request.contextPath}/updatedv" method="post">
            <div class="mb-3">
              <label for="madichvu" class="form-label">Mã dịch vụ</label>
              <input value="${dvV.madichvu}" type="text" class="form-control" id="madichvu" name="madichvu" readonly>
            </div>
            <div class="mb-3">
              <label for="tendichvu" class="form-label">Tên dịch vụ</label>
              <input value="${dvV.tendichvu}" type="text" class="form-control" id="tendichvu" name="tendichvu">
            </div>
