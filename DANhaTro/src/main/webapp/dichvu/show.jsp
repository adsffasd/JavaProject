...
<body>
	    	...
	    	<nav class="navbar navbar-expand-lg bg-light">
			    <div class="container-fluid">
			       <div class="collapse navbar-collapse" id="navbarSupportedContent">
			           <form class="d-flex ml-auto" role="search" action="${pageContext.request.contextPath}/searchdv" method="post">
			               <input class="form-control me-2" type="text" placeholder="Search" aria-label="Search" name="tendichvu">
	...
	<table class="table table-striped">
		...
		<c:forEach items="${listdv}" var="x">
			<tr>
				<td>${x.madichvu}</td>
				<td>${x.tendichvu}</td>
				<td>
					<a href="${pageContext.request.contextPath}/updatedv?madichvu=${x.madichvu}" class="edit-icon" style="color:black; text-decoration:none;">
					  <i class="fas fa-edit"></i> Sửa
					</a>
					<a href="${pageContext.request.contextPath}/deletedv?madichvu=${x.madichvu}" class="delete-icon" style="color:black; text-decoration:none;">
	...
	<a href="dichvu/add.jsp" class="btn btn-outline-secondary" role="button"><i class="fas fa-plus"></i> Thêm</a>
