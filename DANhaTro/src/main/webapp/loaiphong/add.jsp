  ...
  <div class="row justify-content-center">
    <div class="col-md-6">
      <div class="card shadow-sm">
        <div class="card-body">
          <h2 class="card-title text-center mb-4">Thêm loại phòng</h2>
          <form action="${pageContext.request.contextPath}/addlp" method="get">
            <div class="mb-3">
              <label for="maloaiphong" class="form-label">Mã loại phòng</label>
              <input type="text" class="form-control" id="maloaiphong" name="maloaiphong">
            </div>
            <div class="mb-3">
              <label for="tenloaiphong" class="form-label">Tên loại phòng</label>
              <input type="text" class="form-control" id="tenloaiphong" name="tenloaiphong">
            </div>
            <div class="mb-3">
