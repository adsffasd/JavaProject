  ...
  <div class="row justify-content-center">
    <div class="col-md-6">
      <div class="card shadow-sm">
        <div class="card-body">
          <h2 class="card-title text-center mb-4">Thêm thuê phòng</h2>
          <form action="${pageContext.request.contextPath}/addtp" method="post">
            <div class="mb-3">
              <label for="mathue" class="form-label">Mã thuê phòng</label>
              <input type="text" class="form-control" id="mathue" name="mathue">
            </div>
            ...
            <div class="mb-3">
              ...
              <input type="text" class="form-control" id="giaphong" name="giaphong">
            </div>
            <div class="mb-3">
              <label for="tiendatcoc" class="form-label">Tiền đặt cọc</label>
              <input type="text" class="form-control" id="tiendatcoc" name="tiendatcoc">
            </div>
            ...
            <div class="mb-3">
              ...
              <input type="text" class="form-control" id="thanhtoan" name="thanhtoan">
            </div>
