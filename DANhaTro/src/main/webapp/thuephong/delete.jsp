  ...
  <div class="row justify-content-center">
    <div class="col-md-6">
      <div class="card shadow-sm">
        <div class="card-body">
          <h2 class="card-title text-center mb-4">Xóa thuê phòng</h2>
          <form action="${pageContext.request.contextPath}/deletetp" method="post">
            <div class="mb-3">
            ...
            <div class="mb-3">
              ...
              <input value="${tpP.khachthue.getMakhach()}" type="text" name="makhach">
            </div>
            
            <div class="mb-3">
              <label for="phong" class="form-label">phòng</label>
              <input value="${tpP.phong.getMaphong()}" type="text" name="maphong">
            </div>
            ...
            <div class="d-grid gap-2 d-md-flex justify-content-md-end">
              <button type="submit" class="btn btn-outline-secondary me-md-2"><i class="fas fa-trash"></i> Xoá</button>
