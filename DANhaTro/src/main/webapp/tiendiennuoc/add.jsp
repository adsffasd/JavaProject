  ...
  <div class="row justify-content-center">
    <div class="col-md-6">
      <div class="card shadow-sm">
        <div class="card-body">
          <h2 class="card-title text-center mb-4">Thêm tiền điện</h2>
          <form action="${pageContext.request.contextPath}/adddn" method="post">
            <div class="mb-3">
              <label for="matiendien" class="form-label">Mã tiền điện</label>
              <input type="text" class="form-control" id="matiendien" name="matiendien">
            </div>
            
            <div class="mb-3">
              <label for="thue" class="form-label">Thuê phòng</label>
              	<select name="thue" id="thue">
						<c:forEach items="${listTP}" var="x">
            ...
            <div class="mb-3">
              ...
              <input type="date" class="form-control" id="toingay" name="toingay">
            </div>
            
            <div class="mb-3">
              <label for="sodien" class="form-label">Số điện</label>
              <input type="text" class="form-control" id="sodien" name="sodien">
            </div>
            <div class="mb-3">
