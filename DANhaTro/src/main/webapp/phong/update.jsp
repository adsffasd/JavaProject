  ...
  <div class="row justify-content-center">
    <div class="col-md-6">
      <div class="card shadow-sm">
        <div class="card-body">
          <h2 class="card-title text-center mb-4">Sửa thông tin phòng</h2>
          <form action="${pageContext.request.contextPath}/updatept" method="post">
            <div class="mb-3">
            ...
            <div class="mb-3">
              ...
              <input value="${pP.tenphong}" type="text" class="form-control" id="tenphong" name="tenphong">
            </div>
            
            <div class="mb-3">
              <label for="loaiphong" class="form-label">Loại phòng</label>
              <select name="loaiphong" id="loaiphong" class="form-control">
					<c:forEach items="${loaiphonglist}" var="x">
						<option value="${x.getMaloaiphong()}">${x.getTenloaiphong()}</option>
					</c:forEach>
				</select>
            </div>
