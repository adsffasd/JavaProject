...
/**
 * Servlet implementation class DeleteTP
 */
@WebServlet("/deletetp")
public class DeleteTP extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("thuephong/delete.jsp").forward(request, response);
	}
